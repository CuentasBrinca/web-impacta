      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-14">
          <div>
            ...
            <h2
              className="font-[family-name:var(--font-display)] font-bold leading-[0.96] tracking-[-0.035em] mt-5"
        ...
        <div className="border-t border-ink">
          {profiles.map((p, i) => (
            ...
            >
              <div className="hidden md:block font-[family-name:var(--font-display)] text-2xl font-bold text-ink-faint tracking-tight">
                {String(i + 1).padStart(2, "0")}
              </div>
              <div className="font-[family-name:var(--font-display)] text-2xl md:text-[32px] font-bold tracking-[-0.02em] text-ink">
                {p.role}
              </div>
              <div className="font-[family-name:var(--font-body)] text-[13px] font-semibold tracking-[0.14em] uppercase text-blue-500">
                {p.what}
              </div>
              <div className="font-[family-name:var(--font-body)] text-[15px] leading-[1.5] text-ink-soft">
                {p.desc}
              </div>
            </div>
          ))}
