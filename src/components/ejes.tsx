...
export function Ejes() {
  ...
  return (
    <section id="ejes" className="relative bg-[#CFCFCF] overflow-hidden px-6 sm:px-10 py-24 sm:py-32">
      {/* Línea magenta en el cambio de color (blanco → gris) */}
      <div className="absolute top-0 left-0 right-0 h-5 bg-pink-500" />

      <div className="relative mx-auto max-w-[1280px]">
        <div className="max-w-[1180px] mb-16">
          <div className="eyebrow">Tres ejes · un objetivo</div>
          <h2
            className="font-[family-name:var(--font-display)] font-bold leading-[0.96] tracking-[-0.035em] mt-5 mb-4 whitespace-nowrap"
              ...
              >
                ...
                <div className="mt-[35px]">
                  ...
                  <div className="flex items-end justify-between gap-4">
                    <h3
                      className="font-[family-name:var(--font-display)] font-bold tracking-[-0.03em] m-0 leading-none"
                      style={{ fontSize: "clamp(30px, 3vw, 40px)", color }}
                    >
                      {e.title}
                    </h3>
                    <div className="text-right leading-none shrink-0" style={{ color }}>
                      <div className="font-[family-name:var(--font-body)] text-[11px] font-semibold tracking-[0.1em]">
                        EJE
                      </div>
                      <div className="font-[family-name:var(--font-display)] text-lg font-bold mt-1">
                        {e.n}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="font-[family-name:var(--font-body)] text-[15px] font-bold text-white mb-4">
                    {e.sub}
                  </div>

                  <p className="font-[family-name:var(--font-body)] text-[14px] leading-[1.6] text-white/55 m-0">
                    {e.desc}
                  </p>
                </div>
              </motion.article>
